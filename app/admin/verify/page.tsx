...
export default async function AdminVerifyPage({
			...
			<div className='min-h-screen bg-gradient-to-br from-primary via-secondary to-primary flex items-center justify-center p-4'>
				<Card className='max-w-md w-full border-destructive/50'>
					<CardContent className='text-center pt-10 pb-8 space-y-6'>
						...
						<Link href='/admin'>
							<Button className='bg-gradient-to-r from-accent via-primary to-secondary hover:from-accent/90 hover:via-primary/90 hover:to-secondary/90'>
								Request New Link
							</Button>
						</Link>
					</CardContent>
	...
	// Valid token - show admin dashboard
	return <AdminDashboard email={magicToken.email} />;
}
